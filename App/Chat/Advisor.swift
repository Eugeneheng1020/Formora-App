...
enum Advisor {
    ...
    - 跑题或做过头：在做用户这一轮没要的事，或者为一件小事做大范围的排查和验证。
    不要做的：
    ...
    - 有意见：只写一条。开头写级别：【提醒】、【担心】或【必须停】，后面直接对它说问题在哪、怎么改，一两句话。
      【提醒】是小问题，它接着做就行——这条要等它这一轮做完才给它看，不会打断它；【担心】是可能做错了，它下一步之前会读到，由它判断；
      【必须停】会让它立刻停下来，由用户决定要不要继续——只在再做下去会白做、会交出坏结果，或者已经明显偏离用户这一轮的要求时用。
    """
